...
void Player::AdjustVelocityByThrust(float inDeltaTime) { ERROR("Implement"); }

void Player::SimulateMovement(float inDeltaTime)
{
    //    AdjustVelocityByThrust( inDeltaTime );
    // TRACE("Moving Player {} by {} and {}, from location {}, {}",
    // GetPlayerId(), mVelocity.mX, mVelocity.mY, GetLocation().mX,
    // GetLocation().mY);
