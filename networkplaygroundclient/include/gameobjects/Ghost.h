//
// The ghosts of objects. Contains the location of the players that we last know from the server
// USED ONLY FOR READING FROM THE SERVER
...
public:
    ...
    // Which player does this object belong to. Will this make sense for more objects?
